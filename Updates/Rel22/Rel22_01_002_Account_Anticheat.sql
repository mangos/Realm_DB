...
BEGIN
    ...
    SET @cNewDescription = 'Account_Anticheat';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Add account_anticheat table: per-account decaying autoban accumulator (kick_score, ban_count, last_update) for the anti-cheat autoban.';
    ...
    -- Anti-Cheat anti-gaming autoban (Slice 4)
